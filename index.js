...
app.get('/housefull6', function(req, res) {
    console.log('New POST request received for /housefull6 route.');
    return res.status(201).send('Welcome, housefull6 booked successfully.');
})
