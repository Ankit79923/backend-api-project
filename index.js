...
app.get('/housefull9', function(req, res) {
    console.log('New POST request received for /housefull9 route.');
    return res.status(201).send('Welcome, housefull9 booked successfully.');
})
