...
app.get('/housefull', function(req, res) {
    console.log('New POST request received for /housefull route.');
    return res.status(201).send('Welcome, housefull booked successfully.');
})
