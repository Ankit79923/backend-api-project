...
app.get('/housefull10', function(req, res) {
    console.log('New POST request received for /housefull10 route.');
    return res.status(201).send('Welcome, housefull10 booked successfully.');
})
