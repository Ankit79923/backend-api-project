...
app.get('/housefull5', function(req, res) {
    console.log('New POST request received for /housefull5 route.');
    return res.status(201).send('Welcome, housefull5 booked successfully.');
})
